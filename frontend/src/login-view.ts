  ...
  render() {
    return html`
        ...
        >
          <form id="loginForm" name="login" method="POST" action="login" class="flex flex-col">
            ...
            <div class="login-view-avatars">
              <img src="/VAADIN/static/themes/jabber/images/avatars/1.png">
      ...
      <div class="image-attribution p-s">
        Background image by
        <a href="https://flickr.com/photos/wrack/28987657184">Wegdekstreepje</a>. Avatars by <a href="https://www.freepik.com" title="Freepik">Freepik</a>.
      </div>
    `;
  }
